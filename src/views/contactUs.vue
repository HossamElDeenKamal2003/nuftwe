        ...
        <div class="row contact-row no-margin">
            <div class="container">
                ...
                <div style="text-align: center; color: black;">
                    <p style="margin-bottom: 10px; font-size: 15px;"><a href="mailto:info@nuft.com"
                            style="color: black;"><i class="fas fa-envelope-square"></i> info@nuft.com</a></p>
                    <p style="margin-bottom: 10px; font-size: 15px;"><a href="http://wa.me/201285012807"
                            style="color: black;"><i class="fab fa-whatsapp"></i> +20 128 5012807</a></p>
                    <p style="font-size: 15px;">
                        <a href="https://www.facebook.com/NUFT.EG" target="_blank"
                            style="color: black; margin-right: 10px;"><i class="fab fa-facebook-f"></i></a>
                        <a href="https://www.instagram.com/nuft.eg" target="_blank"
                            style="color: black; margin-right: 10px;"><i class="fab fa-instagram"></i></a>
                        <a href="https://www.linkedin.com/company/nufteg/" target="_blank"
                            style="color: black; margin-right: 10px;"><i class="fab fa-linkedin"></i></a>
                        <a href="https://t.me/NUFT_EG" target="_blank" style="color: black; margin-right: 10px;"><i
                                class="fab fa-telegram"></i></a>
                        <a href="https://www.tiktok.com/@NUFT.EG" target="_blank"
                            style="color: black; margin-right: 10px;"><i class="fab fa-tiktok"></i></a>
                        <a href="https://www.youtube.com/@nuft_eg" target="_blank"
                            style="color: black; margin-right: 10px;"><i class="fab fa-youtube"></i></a>
                    </p>
                </div>
                    ...
                    <div class="col-sm-6" style="padding: 20px;">
                        ...
                        <form @submit.prevent="submitForm">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <textarea v-model="form.message" id="message" rows="5" placeholder="Your Message"
                            ...
                            <div id="errorMessages" v-html="errorMessages"
                                style="color: red; font-size: 16px; text-align: center;"></div>
                        </form>
                        <div id="thankYouMessage" v-if="submitted"
                            style="text-align: center; font-size: 28px; padding-bottom: 50px;">
...
export default {
    ...
    methods: {
        submitForm() {
            // Validate form
            const { name, email, number, message } = this.form;
            ...
            if (errorMessage === '') {
                this.submitted = true; // Simulate form submission success
